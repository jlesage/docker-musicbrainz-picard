...
This project implements a Docker container for [MusicBrainz Picard](https://picard.musicbrainz.org).
...
`musicbrainz-picard.domain.tld` to the container at `127.0.0.1:5800`.
...
`server.domain.tld/musicbrainz-picard` to the container at `127.0.0.1:5800`.
